...
module.exports = {
     ...
     */
    botname: process.env.BotName || "Goku",
    ...
    ownernumber: process.env.Owner_Number || "255613667586",
    ...
    packname: process.env.PackName || "Goku",
    ...
    sessionId: process.env.SESSION_ID || "kp9Rc6UXPECYoVFyV_A_N_Y_A_V_2_DA4",
